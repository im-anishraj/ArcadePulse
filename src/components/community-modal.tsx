        ...
        <>
          ...
          >
            <div className="card p-0 overflow-hidden">
              ...
              <button
                onClick={() => setShow(false)}
                className="absolute top-4 right-4 p-2 rounded-full bg-[var(--bg-card)] border border-[var(--border-color)] text-[var(--text-secondary)] hover:text-[var(--text-primary)] z-10"
              >
                <X size={16} />
              </button>
              ...
              <div className="grid md:grid-cols-2">
                ...
                <div className="p-8 border-b md:border-b-0 md:border-r border-[var(--border-color)]">
                  ...
                  <p className="text-sm text-[var(--text-secondary)] mb-2">
                    Connect with over <span className="font-bold text-[var(--text-primary)]">5k</span> members.
                  </p>
                  ...
                  <div className="mt-6 pt-6 border-t border-[var(--border-color)]">
                    ...
                    <div className="flex gap-3">
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="flex-1 py-2.5 rounded-xl bg-[var(--bg-card)] border border-[var(--border-color)] text-sm font-medium text-center hover:border-[var(--accent)] transition-colors"
                      >
